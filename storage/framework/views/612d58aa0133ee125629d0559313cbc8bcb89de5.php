...
<?php $__env->startSection('content'); ?>
	...
	<div class="ot-image-list-table-area">
		<div class="ot-list-table-headline">
			<span>一Operation  </span><button data-url="<?php echo e(url('/admincp/user/deleteAll')); ?>" class="ot-btn-delete js-delete-all">Delete</button>
			<?php if($users->count() > 0): ?>
				<span class="ot-list-row-quantity">Total <?php echo e($users->count()); ?> users</span>
			<?php endif; ?>
		</div>
