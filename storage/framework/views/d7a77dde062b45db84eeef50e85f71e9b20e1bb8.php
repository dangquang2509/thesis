<?php $__env->startSection('title', 'House List'); ?>
...
<?php $__env->startSection('content'); ?>
	...
	<div class="ot-image-list-table-area">
		<div class="ot-list-table-headline">
			<span>一Operation  </span><button class="ot-btn-delete js-delete-all" data-url="<?php echo e(url('/admincp/house/deleteAll')); ?>">Delete</button>
			<?php if($tours->count() > 0): ?>
				<span class="ot-list-row-quantity">Total <?php echo e($tours->count()); ?> houses</span>
			<?php endif; ?>
		</div>
