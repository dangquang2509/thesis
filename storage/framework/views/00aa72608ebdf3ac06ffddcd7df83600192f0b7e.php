...
<?php $__env->startSection('content'); ?>
	<?php $__currentLoopData = $house; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $house): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
	<div class="ot-image-detail-content">
			...
			<div class="base-infos-container">
				<div class="base-infos">
					<div class="left-container">
						<h1 class="title yellow-text-gradient line-bottom"><?php echo e($house->title); ?></h1>
						<div class="description">
							<p><?php echo e($house->description); ?></p>
						</div>
						<div class="list-info">
							<div class="property-type"><?php echo e($house->category_name); ?></div>
		...
		<div class="ot-content">
			<input type="hidden" value="<?php echo e($house->id); ?>" class="tour_id" name="tour_key">
			<div class="ot-image-detail-row">
				<div><a href="/house/full/<?php echo e($house->id); ?>" target="_blank" class="btn-yellow">View house with full screen</a></div>
			</div>
			<div class="ot-image-detail-row">
			...
			<input type="text" name="tour_id" value="<?php echo e($house->id); ?>" style="display:none">
		</div>
	</div>
	...
	<section class="properties">
		<?php $__currentLoopData = $houseSimilar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $house): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
...
<?php $__env->startSection('js'); ?>
	...
	<script type="text/javascript">
	 	...
	 	$(document).ready(function() {
			...
			embedpano({swf:"/vtour/tour.swf", xml:"/<?php echo e($house->xml_url); ?>", target:"pano", consolelog: "false"});
			var width = 600;
			var height = 400;
