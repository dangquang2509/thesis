...
var NotEntered = "球面画像を選択し";
var FileSizeError = "投稿可能のファイルサイズは10MB以下";
var NotJpeg = "このファイルは投稿できません。";
var NotImage = "このファイルは投稿できません。";
var ZeroByte = "このファイルは投稿できません。";
var CanNotPost = "] ファイルの形式は正しくありません。jpgファイルを挿入してください。";
var NoTourTitle = "物件のタイトルを入力する必要があります。";
var NoFloorMap = "フロアプランの入力が必要です。";
var NoSpheres = "360画像を挿入してください。";
var NoPlot = "物件を登録するため、フロアプランに1つまたは複数の球面画像をプロットする必要があります。";
var TourTitleToLong = "物件のタイトルを255文字以内で入力";
var TourCustomkeyToLong = "カスタムキーを100文字以内で入力";
var DuringAjaxWhenRelease = "フロアプラン、球面画像、非三脚画像、注釈画像の投稿中に登録することはできません。";
var DuringAjaxWhenPreview = "フロアプラン、球面画像、非三脚画像、注釈画像の投稿中にプレビューできません。";
var DuringAjaxWhenSave = "フロアプラン、球面画像、非三脚画像、注釈画像の投稿中に一時保存はできません。";
var MoreThan30Spheres = "31個以上の球面画像を登録することはできません。";
var OnlyOneFloorMap = "フロアプラン画像を1つ選択";
var CanNotGetSphere = "以下の球形情報は得られません。 球形のID";
var DuringRestoreWhenRelease = "データの読み取り中は登録できません。";
var DuringRestoreWhenPreview = "データの読み取り中はプレビューできません。.";
var DuringRestoreWhenSave = "データの読み取り中に一時保存はできません。";
var IllegalTourTitle = "コンテンツタイトルを入力してください。";
var IllegalSphereTitle = "球形のタイトルに入力する時使用できない文字 (使用できない文字: < , > , [ , ] )";
var IllegalTourCustomkey = "カスタムキーを半角英数字で入力";
var ExistTourKey = "既に存在したカスタムキーを入力";
var TimeoutUploadSphere = "パラメータ１の投稿は失敗しました。もう一度投稿してください。";
var TimeoutDeleteFloorPlan = "フロアプランの削除は失敗しました。再度削除してください。"
var TimeoutCheckTourKey = "物件キーの確認は失敗しました。もう一度チェックしてください。"
var TimeoutCreateUser = "ユーザーの作成は失敗しました。もう一度作成してください。";
var TimeoutSetTemplete = "テンプレート設定が失敗しました。再度設定してください。";
var TimeoutSaveTourdraft = "一時的保存データの作成は失敗しました。再度作成してください。";
var Plot = "マーカー";
