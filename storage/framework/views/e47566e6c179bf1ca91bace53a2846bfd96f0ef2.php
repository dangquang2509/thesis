...
<?php $__env->startSection('content'); ?>
	<div class="ot-page-title-area">
		...
		<a class="ot-page-title-btn ot-primary-bg" href="" onclick="uploadTour('new', ''); return false;">保存</a>
	</div>
	<form id="postTour" action="#" method="post" accept-charset="UTF-8">
		...
		<div class="ot-form-row">
			...
			<input id="tour-title" name="tour_title" type="text" class="js-tour-title ot-form-row-input" placeholder="コンテンツタイトルを入力"/>
		</div>
		<div class="ot-form-row">
